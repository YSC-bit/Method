...
% rec1 quality index
SSr1=reac1part(:,14);
CODr1=reac1part(:,1)+reac1part(:,2)+reac1part(:,3)+reac1part(:,4)+reac1part(:,5)+reac1part(:,6)+reac1part(:,7);
SNKjr1=reac1part(:,10)+reac1part(:,11)+reac1part(:,12)+i_XB*(reac1part(:,5)+reac1part(:,6))+i_XP*(reac1part(:,3)+reac1part(:,7));
SNOr1=reac1part(:,9);
BODr1=reac1part(:,2)+reac1part(:,4);
BOD5r1=0.65*(reac1part(:,2)+reac1part(:,4)+(1-f_P)*(reac1part(:,5)+reac1part(:,6)));
% rec2 quality index
SSr2=reac2part(:,14);
CODr2=reac2part(:,1)+reac2part(:,2)+reac2part(:,3)+reac2part(:,4)+reac2part(:,5)+reac2part(:,6)+reac2part(:,7);
SNKjr2=reac2part(:,10)+reac2part(:,11)+reac2part(:,12)+i_XB*(reac2part(:,5)+reac2part(:,6))+i_XP*(reac2part(:,3)+reac2part(:,7));
SNOr2=reac2part(:,9);
BOD5r2=0.65*(reac2part(:,2)+reac2part(:,4)+(1-f_P)*(reac2part(:,5)+reac2part(:,6)));

% rec5 quality index
SSr5=reac5part(:,14);
CODr5=reac5part(:,1)+reac5part(:,2)+reac5part(:,3)+reac5part(:,4)+reac5part(:,5)+reac5part(:,6)+reac5part(:,7);
SNKjr5=reac5part(:,10)+reac5part(:,11)+reac5part(:,12)+i_XB*(reac5part(:,5)+reac5part(:,6))+i_XP*(reac5part(:,3)+reac5part(:,7));
SNOr5=reac5part(:,9);
BOD5r5=0.65*(reac5part(:,2)+reac5part(:,4)+(1-f_P)*(reac5part(:,5)+reac5part(:,6)));
